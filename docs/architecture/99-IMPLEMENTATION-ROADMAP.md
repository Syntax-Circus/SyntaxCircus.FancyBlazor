...
| 14 | [Core Kinetic Catalog](PHASE-14-core-kinetic-catalog.md) | Approved | WebGL Rendering Boundary and Preview | Six semantic, fallback-safe kinetic and atmospheric effects |
| 15 | [WebGL Fields and Materials](PHASE-15-webgl-fields-and-materials.md) | Approved | Core Kinetic Catalog | Four typed Three.js effects with lifecycle, fallback, and package-budget proof |
